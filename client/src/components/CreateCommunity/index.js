...
export default class CreateCommunity extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      username: {
        group: "User",
        value: jwt_decode(Cookies.get("rc4git_token")).username.slice(0, -7),
      },
      community: null,
      loading: false,
    ...
    try {
      if (community.group === "Organization") {
        ...
        description = ghOrgResponse.data.description
          ? ghOrgResponse.data.description
          : "";
      } else {
        ...
        >
          <DialogTitle>
            ...
            <p style={{ fontSize: "15px", color: "#8e9299" }}>
              Communities form an umbrella for your channels.
            </p>
          </DialogTitle>
          <DialogContent>
            <div>
              ...
              {community && (
                <>
                  <p style={{ color: "#8e9299" }}>
                    ...
                    <strong>{community.value.concat("_community")}</strong>
                  </p>
                </>
              )}
              <br />
